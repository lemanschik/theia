...
import { PreferenceProxy, PreferenceContribution, PreferenceSchema } from '../preferences/index.js';
import { PreferenceProxyFactory } from '../preferences/injectable-preference-proxy.js';
